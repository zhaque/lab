...
========================
	...
	5. python manage.py synccompres
	6. python manage.py runserver 8001

	(in other shell)
	7. cd projects/user_sites
	8. python manage.py synccompres	
...
* django-batchimport
  Importing data using custom forms from Excel files also
  - [http://code.google.com/p/django-batchimport/]
  - [http://github.com/erikankrom/django-batchimport/]  
  + XLRD Library 
    John Machin's library to read Microsoft Excel Files
