...
class SolrHandlerConfig(models.Model):
    """Configuration for solr queries"""
    
    name = models.CharField(max_length=100)  # Not used now
    
    def __unicode__(self):
        return self.name
    

class SolrField(models.Model):
    """Field name and value to be added to a solr query url as  &name=value"""
    
    field_name = models.CharField(max_length=100)
    field_value = models.CharField(max_length=1000)
    solr_handler_config = models.ForeignKey(SolrHandlerConfig)
