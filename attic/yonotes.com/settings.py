...
_default_css_files = ('saaskit/css/yuiapp.css',
                      'authopenid/css/openid.css',
                      'uni_form/uni-form-generic.css',
                      'uni_form/uni-form.css',
                      'saaskit/css/jquery-ui-1.7.1.custom.css',
                      )
...
COMPRESS_JS = {
    'all' : {
        'source_filenames' : ('authopenid/js/jquery-1.3.2.min.js',
                              ...
                              'saaskit/js/jquery-ui-1.7.2.custom.min.js',
                              'saaskit/js/jquery.tablednd_0_5.js',
                              'saaskit/js/ui.datepicker.js',
                              ),
...
MUACCOUNTS_THEMES = (
    ...
    ('color_scheme', 'Color scheme', (
        ('aqua', 'Aqua', 'saaskit/css/aqua.css'),
        ('green', 'Green', 'saaskit/css/green.css'),
        ('purple', 'Purple', 'saaskit/css/purple.css'),
        ('red', 'Red', 'saaskit/css/red.css'),
        ('tan-blue', 'Tan Blue', 'saaskit/css/tan_blue.css'),
	...
	('grayscalem', 'Grayscale Plus', 'saaskit/css/grayscalemodified.css'),
...
YAHOOID = "V0MDOWrV34EjsPSv3IA9FidwIvW6YK9GacF3YT__yP47rCcT9_b3SCwL5CRu"
