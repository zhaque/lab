...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('crowdsense_channels', (
            ('muaccount', orm['crowdsense.Channels:muaccount']),
            ('channel_slugs', orm['crowdsense.Channels:channel_slugs']),
        ))
        db.send_create_signal('crowdsense', ['Channels'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('crowdsense_channels')
    ...
    models = {
        ...
        'crowdsense.channels': {
            'channel_slugs': ('django.db.models.fields.TextField', [], {}),
            'muaccount': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['muaccounts.MUAccount']", 'unique': 'True', 'primary_key': 'True'})
        },
        'crowdsense.tracker': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'muaccounts.muaccount': {
            ...
            'theme': ('muaccounts.model_fields.PickledObjectField', [], {})
        }
    }
